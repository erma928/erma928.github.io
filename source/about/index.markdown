...
* 2013年，做为 [Greenlife 公司](http://www.greenlifeonefamily.com)的 Contractor，为其开发定制 Accounting 系统。使用 Ruby on Rails 框架。
  ...
  * 快速得到用户反馈，促进实践敏捷开发。
  * 对网站开发有了更清晰整体的理解把握。
* 2013年11月——现在，加入国内第三方支付的初创公司，平安付，作为C门户和收银台的前端JAVA LEAD，领导了一个6人团队，完成了复杂紧迫的业务需求 (Spring MVC)
  * 收银台由最初的支持一家银行到支持上百家银行，包括若干特殊的银行需求；支持各种交易类型，包括外部商户消费；支持网银、带订单帮卡
  * C门户交易历史，绑卡，注册登录等的扩展需求；风控接入的需求
  * 活钱宝需求，即基金购买需求的设计与跟进；得到很大的用户量和交易额
  * 新版收银台的设计与重构，实践了模块化，数据驱动的前后端分离等理念
  * 实践了团队管理，以及多部门合作的有效经验
